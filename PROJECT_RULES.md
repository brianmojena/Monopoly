...
- **Pagos por proximidad**: eliminados (2026-09-25). Se implementaron con **NearbyInteraction (UWB)** porque iOS no permite NFC entre iPhones, pero no funcionaban en la práctica. No reintroducir NearbyInteraction sin aprobación de Brian.
